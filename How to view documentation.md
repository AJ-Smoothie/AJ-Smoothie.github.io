...
With zensical, we can use markdown to generate beautiful documentation, and we can also run javascript in it. This means we can make calculators and stuff. Have I gotten that far yet? Nope. 
...
Open the `site` folder. Each page on the site will have its own folder, i.e. "Rack_Pinion_Calc". Open that folder and open the `.html` file. This will allow you to statically view that singular page. **The links will NOT work.**
